...
```
[FORBIDDEN] Unicode characters: ✓ ✗ ⏳ 🎯 ❌ ✅ … (cause UnicodeEncodeError)
...
### Templates
- **[copilot-instructions-template.md](../02-design/artifact-templates/copilot-instructions-template.md)** - **v2.1.0** (1,902 lines)
...
### Deployment Tools
- **[Apply-Project07-Artifacts.ps1](../02-design/artifact-templates/Apply-Project07-Artifacts.ps1)** - Primer script v1.4.0 (1,396 lines)
...
cd I:\EVA-JP-v1.2\docs\eva-foundation\projects\07-copilot-instructions\02-design\artifact-templates
...
### Quality Gates
- ✅ ASCII-only output in all scripts and documentation
- ✅ Professional components used in all automation (primer script demonstrates this)
- ✅ Evidence collected at operation boundaries (debug artifacts, session checkpoints)
- ✅ Timestamped artifacts for all state captures
- ✅ Self-validating: Project 07 code follows its own standards
...
- Project 06 Patterns: `I:\EVA-JP-v1.2\docs\eva-foundation\projects\06-JP-Auto-Extraction\`
...
- ✅ Template v2.0.0 production-ready (1,200+ lines)
- ✅ Deployment automation with professional components (1,200+ lines)
- ✅ Comprehensive test suite (650+ lines, 60+ test cases)
- ⚠️ Automated test execution (blocked on Pester 5.x)
