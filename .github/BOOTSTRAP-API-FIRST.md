...
function Bootstrap-FromFiles {
    ...
    return @{
        Source = 'files'
        BestPracticesPath = 'C:\AICOE\.github\best-practices-reference.md'
        StandardsPath = 'C:\AICOE\.github\standards-specification.md'
...
try {
    ...
    $bestPractices = Get-Content C:\AICOE\.github\best-practices-reference.md
    $standards = Get-Content C:\AICOE\.github\standards-specification.md
    # Parse as needed
}
```
