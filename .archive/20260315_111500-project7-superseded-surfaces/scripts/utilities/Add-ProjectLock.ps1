<#
.SYNOPSIS
    Add-ProjectLock.ps1 - Distribute Project Lock block to all numbered projects
...
.EXAMPLE
    .\Add-ProjectLock.ps1 -DryRun
    Preview what would be updated without making changes

.EXAMPLE
    .\Add-ProjectLock.ps1
    Apply Project Lock block to all eligible projects
#>
...
$root = "C:\eva-foundry\eva-foundry"
$updated = 0
$skipped_lock = 0
$skipped_depth = 0
$skipped_no_part2 = 0
...
foreach ($f in $all) {
    ...
    # Primary: C:\eva-foundry\<NN>-xxx\.github\copilot-instructions.md
    # or:      C:\eva-foundry\.github\copilot-instructions.md  (workspace root)
