...
```powershell
New-Item -ItemType Directory -Path "C:\eva-foundry\.github\copilot-skills" -Force
```
...
- Add parameter block at top:
  ...
  parameters:
    ...
    repo_path: string  # e.g., "C:\eva-foundry\51-ACA"
    data_model_url: string  # ACA URL or local
  ```

**Deliverable**: `C:\eva-foundry\.github\copilot-skills\sprint-advance.skill.md`

### Task 2.3: Generalize veritas-expert.skill.md

**Changes**: Same pattern as 2.2

**Deliverable**: `C:\eva-foundry\.github\copilot-skills\veritas-expert.skill.md`

### Task 2.4: Generalize gap-report.skill.md

**Deliverable**: `C:\eva-foundry\.github\copilot-skills\gap-report.skill.md`

### Task 2.5: Generalize sprint-report.skill.md

**Deliverable**: `C:\eva-foundry\.github\copilot-skills\sprint-report.skill.md`

### Task 2.6: Generalize progress-report.skill.md

**Deliverable**: `C:\eva-foundry\.github\copilot-skills\progress-report.skill.md`

### Task 2.7: Create Skill Index

**Deliverable**: `C:\eva-foundry\.github\copilot-skills\00-skill-index.skill.md`
...
**Source**: `C:\eva-foundry\51-ACA\.github\DPDCA-WORKFLOW.md` (238 lines)
...
**Deliverable**: `C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\DPDCA-WORKFLOW.md`

### Task 3.2: Sprint Manifest Template

**Deliverable**: `C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\sprint-manifest-template.md`
...
**Deliverable**: `C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\sprint-agent.yml`
...
**Deliverables**:
1. `C:\eva-foundry\51-ACA\Dockerfile` (for 51-ACA)
2. `C:\eva-foundry\51-ACA\.github\workflows\build-sprint-agent.yml` (for 51-ACA)
3. Templates:
   - `C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\Dockerfile.template`
   - `C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\build-sprint-agent.yml.template`
...
**Deliverable**: `C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\scripts-seed-structure.json`
  ...
  "files": [
    {
      ...
      "source": "C:\\eva-foundry\\eva-foundry\\07-foundation-layer\\scripts\\seed-from-plan.py",
      "description": "Parse PLAN.md, assign canonical IDs, seed WBS layer"
    },
    {
      "path": "scripts/reflect-ids.py",
      "source": "C:\\eva-foundry\\eva-foundry\\07-foundation-layer\\scripts\\reflect-ids.py",
      "description": "Write [PROJECT-NN-NNN] inline into PLAN.md"
    },
    {
      "path": "scripts/gen-sprint-manifest.py",
      "source": "C:\\eva-foundry\\eva-foundry\\07-foundation-layer\\scripts\\gen-sprint-manifest.py",
...
$testProj = "C:\eva-foundry\99-test-project"
...
pwsh -File "C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\Apply-Project07-Artifacts.ps1" `
     -TargetPath $testProj
...
```powershell
python "C:\eva-foundry\07-foundation-layer\scripts\seed-from-plan.py" --reseed-model --project-id "99-test-project"
# Expected: [PASS] 2 stories seeded

python "C:\eva-foundry\07-foundation-layer\scripts\reflect-ids.py"
...
```powershell
python "C:\eva-foundry\07-foundation-layer\scripts\gen-sprint-manifest.py" --sprint 01 --name "foundation-test" --stories TEST-01-001,TEST-01-002 --sizes TEST-01-001=XS,TEST-01-002=XS
...
```powershell
node "C:\eva-foundry\48-eva-veritas\src\cli.js" audit --repo $testProj --warn-only
...
**Location**: `C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\copilot-instructions-template.md`
...
**File**: `C:\eva-foundry\07-foundation-layer\02-design\artifact-templates\copilot-instructions-template.md`
...
```powershell
pwsh -File "C:\eva-foundry\07-foundation-layer\scripts\Reseed-Projects.ps1" -Scope active
...
$p33 = "C:\eva-foundry\33-eva-brain-v2\.github\copilot-instructions.md"
...
- Full setup guide: `C:\eva-foundry\07-foundation-layer\docs\github-projects-setup.md`
...
- [ ] 5 skills deployed to `C:\eva-foundry\.github\copilot-skills\`
- [ ] Skill index created
