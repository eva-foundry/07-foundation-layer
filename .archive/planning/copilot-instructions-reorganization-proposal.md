...
After reviewing both workspace-level (`C:\eva-foundry\.github\copilot-instructions.md`) and project-level template (`07-foundation-layer/02-design/artifact-templates/copilot-instructions-template.md`), significant duplication and misplacement of content was identified. This proposal recommends a clear separation of concerns to reduce maintenance burden and improve agent comprehension.
...
**Layer 1: WORKSPACE** (`C:\eva-foundry\.github\copilot-instructions.md`)
...
Path `C:\eva-foundry\.venv\` is workspace-level. Same for all projects. No need to duplicate in every template.
