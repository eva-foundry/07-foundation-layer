# GitHub Copilot Instructions -- Learn Foundry

**Template Version**: 3.0.0
**Last Updated**: February 23, 2026
**Project**: Learn Foundry -- Learning sandbox holding 9 cloned Microsoft reference repos, tutorial Jupyter notebooks, and exploratory spikes feeding the 29-foundry library.
...
4. **Query the data model** for this project's record:
   `powershell
   Invoke-RestMethod "http://localhost:8010/model/projects/42-learn-foundry" | Select-Object id, maturity, notes
   `
