# GitHub Copilot Instructions " EVA Brain v2

**Template Version**: 3.0.0
**Last Updated**: February 23, 2026
**Project**: EVA Brain v2 " Agentic backend (FastAPI + multi-agent)
**Path**: `C:\AICOE\eva-foundation\33-eva-brain-v2\`
**Stack**: Python, FastAPI, Azure AI
